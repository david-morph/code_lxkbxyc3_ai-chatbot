...
const EventsSkeleton = () => {
    return (<div className="-mt-2 flex w-full flex-col gap-2 py-4">
      {placeholderEvents.map(event => (<div key={event.date} className="flex shrink-0 flex-col gap-1 rounded-lg bg-zinc-800 p-4">
...
exports.EventsSkeleton = EventsSkeleton;
//# sourceMappingURL=events-skeleton.js.map