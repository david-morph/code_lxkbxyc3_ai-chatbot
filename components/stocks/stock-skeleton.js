...
exports.StockSkeleton = void 0;
const StockSkeleton = () => {
    return (<div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4 text-green-400">
...
exports.StockSkeleton = StockSkeleton;
//# sourceMappingURL=stock-skeleton.js.map